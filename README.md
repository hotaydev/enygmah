...
<div align="center">
  ...
  <!-- <a href="https://www.npmjs.com/package/@enygmah/cli" alt="NPM Downloads"><img src="https://img.shields.io/npm/dt/@enygmah/cli"/></a> -->
  <!-- <a href="https://www.npmjs.com/package/@enygmah/cli" alt="NPM Version"><img src="https://img.shields.io/npm/v/@enygmah/cli"/></a> -->
</div>
...
To start using enygmah, follow one of these two simple options:
...
Go to our [releases](https://github.com/hotaydev/enygmah/releases/latest) page and download the latest version of enygmah.
...
enygmah is inspired by several unique tools and projects, including [Snyk](https://snyk.io/), [Sonarqube](https://www.sonarsource.com/products/sonarqube/), [Trivy](https://trivy.dev/), [ZAP Proxy](https://www.zaproxy.org/), and [eslint](https://eslint.org/).
...
<p align="center">
    <a href="https://github.com/sponsors/hotaydev"> [Become a sponsor]</a>
</p>

<!-- sponsors --><!-- sponsors -->

## 🗝️ Security Report Authors
...
<p align="center">
    <a href="https://www.producthunt.com/posts/enygmah"
    target="_blank"><img
        src="https://api.producthunt.com/widgets/embed-image/v1/review.svg?post_id=298158&theme=dark"
        align="center"
        alt="enygmah - Security tool | Product Hunt" style="width: 250px; height: 54px;"
