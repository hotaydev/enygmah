...
We just have a CLA to be able to use the community contributions in a comercial way, aiming to license enygmah to companies and large teams. This way we can financially support the project development.

[You can see and sign our CLA here][individual-cla].
